...
import TokenDropdown from "./token";
...
const SelectPare = () => {
  ...
  return (
    <>
      <div
        className="lg:w-[820px] h-[701px] rounded-[8px] p-6 flex flex-col border bg-[#1E1E49EB] border-[#162A69]"
        style={{ height: "auto", margin: "auto" }}
      >
        <span className="text-left mb-2 text-[16px] font-[500] font-['Inter']">
          Pool Pair
        </span>
        <div className="flex md:flex-row flex-col md:gap-2 gap-y-2 mb-2">
          <div className="bg-transparent flex items-center gap-4 rounded-[8px] md:w-[382px] border border-[#162A69] p-2 ">
            <img
          ...
          <div className="relative">
            <div className="bg-transparent flex items-center justify-between gap-4 rounded-[8px] md:w-[382px] w-full border border-[#162A69] p-2 cursor-pointer">
              <TokenDropdown />
            </div>
            <div className="absolute top-full left-0 w-full mt-1 bg-[#0D1836] border border-[#162A69] rounded-[8px] overflow-hidden z-10 hidden">
              <div className="p-2 hover:bg-[#162A69] cursor-pointer">USDT</div>
              <div className="p-2 hover:bg-[#162A69] cursor-pointer">
                Vanguard (VOO)
              </div>
              <div className="p-2 hover:bg-[#162A69] cursor-pointer">
                SPDR (SPY)
        ...
        <div className="flex text-left justify-between pr-4 mb-2">
          <div className="flex flex-col space-y-2 ">
            <span className="font-[Inter] font-[500] text-[16px]">
              Fee tier
            </span>
        ...
        <div className="flex justify-between p-1 rounded-[4px]">
          ...
          <div className="flex gap-2 p-2 border border-[#162A69]">
            ...
            <span className="bg-[#162A69] text-[14px] font-[Inter] font-[500]">
              ETFS
            </span>
          </div>
        </div>
...
export const PercentageBox = ({ value1, value2, isSelected, onClick }) => {
  return (
    ...
    >
      ...
      <span className="text-[14px] font-[400] text-[Inter] text-[#FFFFFFCC]">
    ...
    <div className="w-full h-[120px] rounded-[8px] bg-[#162A69] p-3">
      <div className="flex flex-col space-y-3">
        <div className="flex justify-between">
          <span className="text-[14px] font-[inter] font-[400] text-[#FFFFFFCC]">
            {priceLable}
          </span>
          <button
