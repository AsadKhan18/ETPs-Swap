...
import { SelectPare, Swap, Staking, SwapSell } from "../";
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case "stake":
        return <Staking />;
      case "sell":
        return <SwapSell Sell={Sell} Buy={Buy} title="sell" />;
      case "buy":
        return <Swap Sell={Buy} title="buy" />;
      default:
        return <div />;
    }
  };
        ...
        <div className={styles.tabflex}>
          <div className={styles.tabs}>
            {tabData.map(({ key, label, image }) => (
              <div
                key={key}
                className={`${styles.tabContainer} ${styles.imageandnavitem}`}
              >
                <button
