...
const TokenSelector = ({
                           ...
                           setselectedItemCallBack = (item) => {
                           },
                           selectedBoxHeight = "auto",
                           hideIcon = false,
                           hideSymbol = false,
                           hideName = false,
                           hideSearch = false,
                           selectedIconHeight = "60px",
                           disabled = false,
                           hideETH = false,
                       }) => {
    ...
    return (
        <div
            ...
            ref={selectRef}
            style={{height: selectedBoxHeight}}
        >
            <div
            ...
            >
                ...
                <span className={styles.selectedText}>{selectedToken.symbol}</span>
                {!disabled && (
                    <img
